...
def clean():
    df = pd.read_csv('N-S-VS1.tsv', sep="\t")
    # print(df)
...
def parse_lines():
    ...
    df = pd.read_csv("N-S-VS1_vehicleClass-noSH.png.csv")
    name = "AAAA_N-S-VS1_vehicleClass-noSH_PARSED"
    stimulus = "vehicleClass.png"
